  ...
  function create(options){
    ...
    function openGuide(){
      ...
      for(const [heading,text] of [
        ['「✦ + 1.2」是什么意思？','✦ 表示醉意。这杯喝完共增加 1.2 醉意，分每一口逐次计入；醉意最高为 10，到达上限后不再增加。具体数值以当前酒单为准。无酒精饮品不增加醉意。'],
        ['怎么点酒？','点一款酒，就能展开介绍；再点一次或点 close 收起。选好后点「确定」，这一杯会先锁定，并带你回到聊天页面。'],
        ['锁定以后呢？','写句话，再按发送，把酒一起递给 Ta；也可以直接发送。Ta 接过喝下后计入醉意，也可以推回这杯酒。'],
        ['小条上的 2/4 是什么？','表示这杯还剩 2 口，总共 4 口。喝完显示空杯；放久后被收走会另行提示，不会把剩余酒量算作喝下。玻璃管显示当前醉意，越满、越红表示醉意越高。'],
        ['盲品是什么？','酒单最上面的「盲品」会端上六个看不出内容的杯子：三杯白水、两杯普通酒、一杯最烈的。点确定后回到聊天，从小纸条进去选杯，你先选，之后和 Ta 轮流。Ta 揭到酒就整杯记醉意；你揭到酒，会翻出一张整蛊纸条，随消息交给 Ta，当场兑现。'],
